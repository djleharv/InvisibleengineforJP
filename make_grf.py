...
newgrf_name = "Invisible Engine and Wagon for JPplus"
...
openttd_path = "C:/Users/Owner/Documents/OpenTTD/newgrf"
...
# Run 
nmlc = subprocess.run(["nmlc", "-c", "-t", "src/custom_tags.txt", "-l", "lang/", "--grf", grf_name, merged_nml_path], stdout = subprocess.PIPE, stderr = subprocess.PIPE, text=True)
print(nmlc.stdout)
print(nmlc.stderr)
